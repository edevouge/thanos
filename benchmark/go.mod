...
require (
	...
	github.com/prometheus/prometheus v2.0.0+incompatible
	github.com/prometheus/tsdb v0.0.0-20180711112126-99a2c4314ff7
	google.golang.org/api v0.0.0-20180711000437-1d2d9cc0ae74
